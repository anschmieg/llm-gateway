...
const CopilotAPIConfig: ProviderAPIConfig = {
  getBaseURL: (opts = {}) => opts.providerOptions?.baseURL || process.env.COPILOT_PROXY_URL || COPILOT_PROXY_URL,
  headers: ({ providerOptions }) => {
    const apiKey = providerOptions.apiKey || process.env.COPILOT_API_KEY || COPILOT_API_KEY;
